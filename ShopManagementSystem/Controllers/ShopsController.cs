...
namespace ShopManagementSystem.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShopId,Name,MobileNumber,Place,Item,Total,CreatedDate,ModifiedDate")] Shop shop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShopId,Name,MobileNumber,Place,Item,Total,CreatedDate,ModifiedDate")] Shop shop)
        {
            if (id != shop.ShopId)
            {
                return NotFound();
